...
public class ExhibitionCommand implements Command {
    ...
    public String show(HttpServletRequest request) {
        ...
        final long numberOfExpositions = expositionService.count(id);
    ...
    private void setExpositionAttributes(HttpServletRequest request, HttpSession session, int inCart, long numberOfExpositions,
